...
import { Link, Redirect } from 'react-router-dom'; //FIX LATER
import { connect } from 'react-redux';
import PropTypes from 'prop-types';
import {primaryColor} from "../../primaryColor";
// reactstrap components

import qrPhone from '../../img/qrPhone.png';
import menuPhone from '../../img/menuPhone.png';
import cameraPhone from '../../img/cameraPhone.png';
//import Image from 'react-bootstrap/Image'; //Not using, but it's here if needed
//import AdaptiveImage from 'react-adaptive-image'; //We want to use this, but it doesn't work
import {
  Button,
  Row,
  Col
      ...
      >
        ...
        <section>
          ...
          <Row style={{ marginTop: '60px' }}>
            ...
            <Col>
              <div style={{ paddingTop: '100px', marginLeft: '50px' }}>
                <h2
                  style={{
                    color: 'white',
                    fontSize: '30px',
        ...
        <section>
          <Row style={{ marginTop: '100px' }}>
            <Col>
              <div style={{ paddingTop: '100px', marginLeft: '390px' }}>
                <h2
                  style={{
                    color: 'white',
                    fontSize: '30px',
